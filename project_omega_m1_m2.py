...
Modules : 1 — Setup, Config, Logging, Google Drive
          2 — Environment Wrapper (LunarLander-v3), Reward Shaping, Normalization
================================================================================
...
class RLConfig:
    ...
    All values are chosen for overnight Colab T4 training on LunarLander-v3.
    """
    # ── Environment ──────────────────────────────────────────────────────────
    ...
    state_dim: int                = 8      # LunarLander-v3 observation dim
    action_dim: int               = 4      # LunarLander-v3 discrete actions
