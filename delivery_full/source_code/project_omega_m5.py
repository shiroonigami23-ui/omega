...
# Action label map for LunarLander-v2
...
class VisualizationEngine:
    ...
    def plot_performance_curve(self) -> Path:
        ...
        ax1.set_title("D3QN Training Performance — LunarLander-v2", fontweight="bold")
    ...
    def plot_state_visitation_heatmap(self) -> Path:
        ...
        LunarLander-v2 observation layout:
    ...
    def plot_ablation_comparison(self) -> Path:
        ...
        ax.set_title(
            ...
            "LunarLander-v2 | D3QN Research Pipeline",
            fontweight="bold",
        )
