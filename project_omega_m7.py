...
class PPTXCompiler:
    ...
    def _slide1_title(self, prs, layout) -> None:
        ...
        sb.add_textbox(
            "An Ablation Study on LunarLander-v3  |  Project Omega",
        ...
        sb.set_notes(
            ...
            "LunarLander-v3 environment, conducts a four-variant ablation study, "
    ...
    def _slide2_exec_summary(self, prs, layout) -> None:
        ...
        sb.set_notes(
            ...
            "LunarLander-v3 through the combined effect of Dueling architecture "
