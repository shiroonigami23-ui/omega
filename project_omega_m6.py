...
class ReportContent:
    ...
    MATH_SECTIONS: List[Tuple[str, str]] = [
        ...
        (
            ...
            (
                ...
                "flight cruise in LunarLander-v3)."
            ),
        ),
        (
    ...
    def abstract(self) -> str:
        ...
        return (
            ...
            f"research pipeline for the LunarLander-v3 continuous-state "
    ...
    def conclusion(self) -> str:
        ...
        if solved:
            verdict = (
                f"The D3QN agent successfully solved LunarLander-v3, "
            ...
            verdict = (
                f"The D3QN agent did not formally solve LunarLander-v3 "
...
def _render_fpdf(
    ...
    pdf.multi_cell(
        ...
        "An Ablation Study on LunarLander-v3",
        align="C",
    )
    pdf.ln(3)
    ...
    embed_image(
        "performance_curve", 1,
        "Reward trajectory of the full D3QN agent on LunarLander-v3. "
